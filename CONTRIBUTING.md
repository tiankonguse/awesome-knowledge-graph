# Contributing to awesome-knowledge-graph

(This document is based on [librdkafka's CONTRIBUTE.md](https://github.com/edenhill/librdkafka/blob/master/CONTRIBUTING.md) - thank you!)
...
# awesome-knowledge-graph C style guide
